	...
	<div class="body">
		...
		<div role="main" class="main">
					...
					<div class="row py-5 mb-5 mt-2 p-relative z-../user/index-1">
						<div class="col">
							...
							<div class="overflow-hidden mb-4">
								<h1 class="d-block text-color-quaternary font-weight-bold text-center line-height-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">Search Engine
									Optimization</h1>
							</div>
						</div>
					</div>
				...
				<div class="container pb-2 mb-4">
					<div class="row justify-content-center align-items-center">
						<div class="col-md-10 col-lg-6 mb-5 mb-lg-0">
							<h2 class="text-color-dark font-weight-semibold text-6 line-height-3 mb-0 pe-5 me-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Lorem ipsum
								dolor sit amet, consec tetur adipiscing elit.</h2>
							...
							<p class="lead pe-5 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000">Lorem ipsum dolor sit amet, consectetur adipiscing
								elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur.</p>
							<div class="feature-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2200">
								...
								<div class="feature-box-info mb-4 pb-3">
									<h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Content Writing
										and Organization</h4>
									<p class="mb-0">Consectetur adipiscing elit. Sed imperdiet libero id nisi euismod
							...
							<div class="feature-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2400">
								...
								<div class="feature-box-info">
									<h4 class="font-weight-bold line-height-3 custom-font-size-1 mb-1">Site Map
										Improvements and Directions</h4>
									<p class="mb-0">Consectetur adipiscing elit. Sed imperdiet libero id nisi euismod
										sed porta est consectetur.</p>
								</div>
							</div>
						...
						<div class="col-md-10 col-lg-12 mt-4">
							<p class="mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">Lorem ipsum dolor sit amet, consectetur adipiscing
								elit. Sed volutpat nisl a sapien dignissim, at tristique nibh dapibus. Quisque faucibus
								feugiat libero, ut placerat enim pretium nec. Donec non elit vitae mi pharetra gravida.
								In eu mauris lectus. Nam blandit suscipit enim id vehicula. Pellentesque commodo
								convallis neque, viverra lacinia erat feugiat ut. Proin sed ligula egestas, laoreet
								lorem vitae, vehicula sapien. Mauris facilisis velit eu laoreet aliquet. </p>
							<p class="pb-5 mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="350">Praesent finibus pretium scelerisque. Pellentesque sit
								amet ullamcorper nibh. Quisque et nisi mauris. Nunc eget rutrum massa. Nam eu auctor
								nisi. Phasellus vestibulum consequat enim. Duis fringilla orci at sem venenatis
								dignissim. Curabitur sollicitudin libero a diam auctor, sed lobortis nulla venenatis.
							</p>
						</div>
					</div>
				</div>
			...
			<section class="section position-relative custom-bg-color-light-2 border-0 pt-5 pt-lg-4 m-0">
				...
				<div class="container position-relative z-../user/index-1 pb-lg-4 mb-lg-5">
					<div class="custom-circle custom-circle-medium custom-circle-pos-44 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="200">
						<div class="custom-bg-color-grey-1 rounded-circle w-100 h-100" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.8, 'transition': true, 'transitionDuration': 3000}">
						</div>
					</div>
					<div class="custom-circle custom-circle-small custom-circle-pos-45 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="500">
						<div class="custom-bg-color-grey-2 rounded-circle w-100 h-100" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'transition': true, 'transitionDuration': 2000}">
						</div>
					</div>
					<div class="custom-circle custom-circle-extra-small custom-circle-pos-46 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="800">
						<div class="custom-bg-color-grey-2 rounded-circle w-100 h-100" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'transition': true, 'transitionDuration': 1500}">
						</div>
					</div>
					<div class="row justify-content-center mb-3">
						<div class="col-md-10 col-lg-8 text-center">
							...
							<p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">Lorem ipsum dolor sit amet, consectetur adipiscing
								elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Sed imperdiet
								libero id nisi euismod</p>
						</div>
					</div>
						...
						<div class="col-md-8 col-lg-4">
							<div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
								...
								<div class="plan-header bg-color-light pt-5 px-4">
									<h4 class="text-color-dark font-weight-bold text-color-quaternary text-5 mt-4 mb-2">
										Basic Plan</h4>
									<p class="px-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
										imperdiet libero id nisi.</p>
								</div>
								...
								<div class="plan-footer pt-3 pb-5">
									<a href="#" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">HIRE
										NOW</a>
								</div>
							</div>
						</div>
						<div class="col-md-8 col-lg-4">
							<div class="plan plan-featured bg-color-quaternary text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
								...
								<div class="plan-header bg-color-quaternary pt-5 px-4">
									<h4 class="text-color-light font-weight-bold text-5 mt-4 mb-2">Professional Plan
									</h4>
									<p class="text-color-light font-weight-light opacity-6 px-2 mb-0">Lorem ipsum dolor
										sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi lorem.</p>
								</div>
								<div class="plan-features px-4">
									<ul>
								...
								<div class="plan-footer pt-3 pb-5">
									<a href="#" class="btn btn-light-2 btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">HIRE
										NOW</a>
								</div>
							</div>
						</div>
			...
			<section class="section bg-color-light position-relative border-0 pb-4 m-0">
				...
				<div class="container position-relative z-../user/index-1">
					<div class="row mt-5 mb-5">
						<div class="col-lg-4 pe-lg-0">
							<h2 class="text-color-dark font-weight-semibold text-6 line-height-3 mb-3">Check out what
								are clients are saying about us</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi
								euismod, sed porta est consectetur. Sed imperdiet ibero id nisi euismod, sed porta est
								consectetur.</p>
						</div>
